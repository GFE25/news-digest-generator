...
def filter_entries(company, entries):
    ...
    if company == "ソフトバンク":
        excluded_keywords = ["ホークス", "野球", "選手", "打者", "打撃", "優勝", "王会長", "連戦", "2ラン", "3ラン", "先制", "今季", "4番", "登録抹消", "投手", "試合", "連勝", "連敗", "引き分け", "猛打賞", "復帰", "離脱", "捕手", "安打", "監督", "球場", "打点", "ヒット", "二塁打", "三塁打", "巨人", "ホームラン", "１軍", "城島", "失点", "打球", "先発", "最下位", "起用", "退場", "守護神", "球団"]
